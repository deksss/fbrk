...
if (!is_admin()) {
	...
	wp_register_script( 'jquery', get_bloginfo('stylesheet_directory').'/libs/jquery-1.11.3.min.js');
	...
	wp_enqueue_script( 'jquery_ui', get_bloginfo('stylesheet_directory').'/libs/jquery-ui.custom.min.js' );
        wp_enqueue_script( 'jquery_lazyload', get_bloginfo('stylesheet_directory').'/libs/jquery.lazyload.min.js' );
